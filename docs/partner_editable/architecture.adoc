...
* AWS Security Hub to compile findings of automated and continuous checks of AWS resources against the Payment Card Industry Data Security Standard (PCI DSS) and AWS Foundational Security Best Practices standards. Custom actions in Security Hub send findings to AWS CloudWatch as custom action events. 
